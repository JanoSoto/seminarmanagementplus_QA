...
ALTER TABLE alumno_id_alumno_seq OWNER TO postgres;
...
ALTER TABLE profesor_id_profesor_seq OWNER TO postgres;
...
--
-- Name: public; Type: ACL; Schema: -; Owner: giovanni
--

REVOKE ALL ON SCHEMA public FROM PUBLIC;
REVOKE ALL ON SCHEMA public FROM giovanni;
GRANT ALL ON SCHEMA public TO giovanni;
